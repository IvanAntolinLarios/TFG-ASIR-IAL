...
export PS1='\[\e[97;45m\] KING \[\e[0m\] \[\e[1;33m\]\u@\h\[\e[0m\]:\[\e[1;36m\]\w\[\e[0m\]\$ '
EOF

# Usuario ROOT
cat << 'EOF' >> /root/.bashrc
# PS1 Personalizado - ROOT
export PS1='\[\e[97;41m\] [ ROOT @ KING ] \[\e[0m\] \[\e[1;33m\]\u\[\e[0m\]:\[\e[1;31m\]\w\[\e[0m\]# '
EOF

# 2. Desactivar mensajes por defecto de Linux Mint
