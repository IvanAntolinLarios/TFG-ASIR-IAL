...
export PS1='\[\e[4;30;48;5;208m\] DOCKER-WORKER \[\e[0m\] \[\e[38;5;208m\]\u@\h\[\e[0m\]:\[\e[1;37m\]\w\[\e[0m\]\$ '
EOF

# Usuario ROOT
cat << 'EOF' >> /root/.bashrc
# PS1 Personalizado - ROOT
export PS1='\[\e[97;41m\] [ ROOT @ DOCKER-WORKER ] \[\e[0m\] \[\e[1;33m\]\u\[\e[0m\]:\[\e[1;31m\]\w\[\e[0m\]# '
EOF
